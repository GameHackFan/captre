class PatchService
{
  ...
  applyPatch = (extras) =>
  {
    try
    {
      ...
      romService.applyPatch(gfxPatch1);
      romService.applyPatch(gfxPatch2);
      romService.applyPatch(gfxPatch3);
      romService.applyPatch(gfxPatch4);
      romService.applyPatch(gfxPatch5);
      romService.applyPatch(gfxPatch6);
      romService.applyPatch(gfxPatch7);
      romService.applyPatch(gfxPatch8);
